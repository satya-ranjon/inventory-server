...
interface ISalesOrderDocument
  extends Document,
    Omit<ISalesOrder, keyof Document> {}
...
SalesOrderSchema.pre("save", function (next) {
  // First convert to unknown, then to ISalesOrderDocument
  const salesOrder = this as unknown as ISalesOrderDocument;
...
export default mongoose.model<ISalesOrderDocument>(
  "SalesOrder",
  SalesOrderSchema
);
